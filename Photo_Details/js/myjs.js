...
function showDetails() {
    ...
    let details = {
        ...
        "Manvitha" : "23951A6699 Student of CSE(AI & ML)"
    };
    ...
    let confirmed = confirm("Are you sure you want to search this person?");
    if (!confirmed) {
        // User clicked Cancel → do nothing,
        // so old photo & details remain on the screen.
        return;
    }
    if (!photos[name] || !details[name]) {
        alert("No details found for this person.");
        return;
    }
